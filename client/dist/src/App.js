...
function App() {
    ...
    return (react_1.default.createElement("div", { className: "App" },
        react_1.default.createElement(antd_1.Layout, { className: "layout" },
            react_1.default.createElement(Header, null,
                react_1.default.createElement(antd_1.Typography.Title, { style: { color: "#fff5ee" } }, "ToDo List")),
            react_1.default.createElement(Content, { className: "content" },
                react_1.default.createElement(mainScreen_1.MainScreen, { socket: socket, userToFilterBy: userToFilterBy })),
            react_1.default.createElement(Footer, { className: "footer" },
                react_1.default.createElement(bottomNav_1.BottomNav, { setFilter: setUserToFilterBy })))));
}
exports.default = App;
