...
const MainScreen = (props) => {
    ...
    return react_1.default.createElement("div", { className: "mainScreen" },
        react_1.default.createElement(taskList_1.TaskList, { className: "list", title: "All Tasks", taskList: props.userToFilterBy ?
                tasks.filter(t => t.assignTo === props.userToFilterBy).sort() :
                tasks.sort() }),
        react_1.default.createElement(taskList_1.TaskList, { className: "list", title: "Done", taskList: props.userToFilterBy ?
        ...
        react_1.default.createElement(taskList_1.TaskList, { className: "list", title: "To Do", taskList: props.userToFilterBy ?
                tasks === null || tasks === void 0 ? void 0 : tasks.filter(t => !t.completed && t.assignTo === props.userToFilterBy).sort() :
                tasks === null || tasks === void 0 ? void 0 : tasks.filter(t => !t.completed).sort() }));
};
